...
I have long had "playing around with census data" on my to do list, but was never able to make the time for it until coding assistants came around.  I used Claude to help me plumb the depths of census.gov annual population estimates + survey data and then extract variables I thought were interesting.  Claude then coded my vision of an interactive map using d3.js.
...
I have the final product hosted on cloudflare's free tier:  [censusdataproject.org](https://censusdataproject.org)
